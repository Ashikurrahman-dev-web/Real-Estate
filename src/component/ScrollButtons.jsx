      ...
      <AnimatePresence>
        {showUp && (
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={scrollToTop}
            className="pointer-events-auto w-10 h-10 sm:w-12 sm:h-12 rounded-full glass-card flex items-center justify-center text-white shadow-2xl border border-outline-variant/20 hover:bg-green-500-container hover:text-white transition-colors"
          >
